...
;(function(window, document) {
    ...
    /** The id for the document expando */
    var expandID = 0;
    ...
    (function() {
        try {
            ...
            // assing a false positive if detection fails => unable to shiv
    ...
    /**
     * Create a style sheet with the given CSS text and adds it to the document.
     * @private
    ...
    function getExpandoData(ownerDocument) {
        ...
        if (!data) {
            data = {};
            expandID++;
            ownerDocument[expando] = expandID;
            expandoData[expandID] = data;
        }
        return data;
    }
